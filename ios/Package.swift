...
let package = Package(name: "VergeFieldCore", platforms: [.macOS(.v12), .iOS(.v17)], products: [.library(name: "VergeFieldCore", targets: ["VergeFieldCore"])], targets: [
    .target(name: "VergeFieldCore", path: "VergeCommon", exclude: ["VergeCommonApp.swift", "WorkspaceViews.swift", "Assets.xcassets"], sources: ["FieldDraft.swift", "CommunityAPI.swift", "WorkspaceAPI.swift"]),
